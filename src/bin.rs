...
fn solve_problem<R: Rng, A: Api>(problem: Problem, api: &mut A, stats: &mut Statistics,
                                 rng: &mut R, gen: &mut RandomGen) {
...
fn fetch_n_random_testcases<R: Rng, A: Api>(p: Problem, n: uint, api: &mut A, rng: &mut R)
    -> ~[(u64, u64)] {
